...
public class DocumentServiceClient {
	...
	public static void main (String args[]) {
		...
		bp.getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, "http://mgwativosgestaoeadmi3732.fluig.cloudtotvs.com.br/webdesk/DocumentService");
	...
	public void setParameters() throws Exception {
		...
		this.numeroDocumentPai = 1394;
		this.numeroPastaParticular = 110;
		this.qtdeDocumentosBusca = 3;
		this.arquivo = "C:\\temp\\Documento.docx";
		this.nomeArquivo = "Documento.docx";
	...
	public void createDocument() throws Exception {
		...
		// Cria documento.
		this.documentDto.setApprovalAndOr(true); //Informe 'false' para utilizar tipo de aprovação OU e 'true' para utilizar tipo de aprovação E.
		...
		this.documentDto.setExpires(true); //Documento Expira?
	...
	public void deleteDocument() throws Exception {
		...
		if (this.documentDtoArray.getItem().get(0) != null) {
			...
			// Exclui um documento e envia para a lixeira.
			this.webServiceMessageArray = service.deleteDocument(this.loginColaborador, this.senhaColaborador, (int) this.documentDtoArray.getItem().get(0).getCompanyId(), this.documentDtoArray.getItem().get(0).getDocumentId(), this.matriculaColaborador);
