...
public class MailHelperMGW implements Serializable{
	...
	public boolean mail_smtp_useSSL = true;
	public String mail_smtp_user = "valdir.pandolfi@mgwativos.com.br";
	public String mail_smtp_password= "mgw2018*";
	public String mail_smtp_host = "email-ssl.com.br";
	...
	private List<AttachmentHelper> getAttachments() {
		if (attachments == null) {
			attachments = new ArrayList<MailHelperMGW.AttachmentHelper>();
		}
		return attachments;
	}
	
	public static MailHelperMGW newInstance() {
		return new MailHelperMGW();
	}
	...
	public MailHelperMGW addEmailTo(String mailTo) {
		getMailsTo().add(mailTo);		
		return this;
	}
	
	public MailHelperMGW setSubject(String subject) {
		this.subject = subject;
		return this;
	}
	
	public MailHelperMGW setMessage(String message) {
		this.message = message;
		return this;
	}
	
	public MailHelperMGW addAttachment(String filename, File attachment) {
