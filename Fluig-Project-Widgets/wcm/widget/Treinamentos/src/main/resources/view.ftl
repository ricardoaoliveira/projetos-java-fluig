...
<div id="Treinamentos_${instanceId}" class="wcm-widget-class super-widget fluig-style-guide" 
	data-params="Treinamentos.instance(${parameters})">

	<h2 class="page-header"> 
    	<span class="fluigicon fluigicon-user-role"></span>
        ${i18n.getTranslation('application.title')}
    </h2>
    
    <p>${i18n.getTranslation('header.information')}</p>
