var ListaTelefones = SuperWidget.extend({
	...
	searchData: function() {
		...
		var fields = new Array("id", "nm", "ramal", "fone");
		var sortingFields = new Array("nm");
				
		var dataset = DatasetFactory.getDataset("ds_telefones", fields, constraints, sortingFields);
